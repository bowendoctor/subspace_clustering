...
data = np.genfromtxt("meipaidata", delimiter=' ')
#put labels in y
y = np.zeros(18)
y[9:18] = 1
'''
...
print('K-Means')
start = time.time()
[u, centroids, ite, dist_tmp] = cl.k_means(data, 2, replicates=10)
print('Time elapsed: ', time.time()-start)
print('Accuracy: ', cl.my_math.compare_categorical_vectors(u, y)[0])
print centroids
'''
...
print('WK-Means')
start = time.time()
[u, centroids, weights, ite, dist_tmp] = cl.wk_means(data, 2, 1.1, replicates=10)
print('Time elapsed: ', time.time()-start)
print('Accuracy: ', cl.my_math.compare_categorical_vectors(u, y)[0])
...
print('MWK-Means')
start = time.time()
[u, centroids, weights, ite, dist_tmp] = cl.mwk_means(data, 4, 10, replicates=10)
print('Time elapsed: ',time.time()-start)
print('Accuracy: ', cl.my_math.compare_categorical_vectors(u, y)[0])
####################################################################
